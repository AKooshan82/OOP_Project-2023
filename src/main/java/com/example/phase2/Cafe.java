...
public class Cafe implements Initializable {
    ...
    private ImageView fastFoodImage(){
        Image image = new Image("C:\\Users\\Victus\\Desktop\\java\\phase2\\phase2\\src\\main\\resources\\com\\example\\phase2\\coffee.png");
    ...
    public void initMain(){
        ...
        for (Restaurant restaurant : App.restaurants){
            if (restaurant.type.equals("Cafe")) {
