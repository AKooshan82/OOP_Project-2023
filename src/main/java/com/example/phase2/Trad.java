...
public class Trad implements Initializable {
    @Override
    ...
    private ImageView fastFoodImage(){
        Image image = new Image("C:\\Users\\Victus\\Desktop\\java\\phase2\\phase2\\src\\main\\resources\\com\\example\\phase2\\kebab.png");
    ...
    public void initMain(){
        ...
        for (Restaurant restaurant : App.restaurants){
            if (restaurant.type.equals("Traditional")) {
                ImageView iw = fastFoodImage();
                Button b = new Button("", iw);
                b.setGraphic(iw);
                b.setText(detail(restaurant));
                b.setPrefSize(Utility.SHOW_REST_BUT, 60);
                b.setOnAction(event -> {
                    try {
